...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Navbar with Logo (same as login/signup) */}
      ...
      {/* Hero Section (card style matching login/signup) */}
      <div className="max-w-7xl mx-auto px-4 py-16 sm:py-24">
        <div className="text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              href="/register"
              className="bg-purple-600 text-white px-8 py-3 rounded-full font-semibold hover:bg-purple-700 shadow-md transition"
            >
              Create Free Account
            </Link>
            <Link
              href="/login"
              className="bg-white text-purple-600 border border-purple-600 px-8 py-3 rounded-full font-semibold hover:bg-purple-50 transition"
            >
              Sign In
            </Link>
          </div>
      ...
      {/* Features Grid (matching card style from login/signup) */}
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm">Create your free account using email</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-purple-100 text-purple-600 rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-3">2</div>
              <h3 className="text-lg font-semibold">Activate Account</h3>
              <p className="text-gray-500 text-sm">Pay 500 BDT activation fee via bKash/Nagad/Rocket</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm">Refer friends, complete tasks, withdraw earnings</p>
            </div>
          </div>
        </div>
      </div>
